...
class ArticleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('articles')->insert([
            ...
            'content'=>'В этом царстве существуют и хищники, и жертвы, и они следуют великому закону жизни и выживания. Плывущие стаи меняют тотальные картины подводного мира, создавая иллюзии бесконечности. Некоторые рыбы, как цветные палитры художника, излучают яркие оттенки, а другие, словно тени, маскируются в окружении кораллов.',
            'likes'=>'22',
            'views'=>'162',
            'image'=>'https://placehold.co/600x400',
            'category_id'=>2,
        ...
        DB::table('articles')->insert([
            ...
            'content'=>'Черные дыры являются одним из самых загадочных объектов во Вселенной. Эти области пространства обладают такой сильной гравитацией, что даже свет не может покинуть их. Наиболее известные черные дыры образуются в результате коллапса массивных звезд. Недавние исследования показывают, что черные дыры могут быть связаны с формированием галактик. Ученые обсуждают теории о том, могут ли черные дыры быть порталами в другие измерения. Эти обсуждения поднимают много интересных вопросов о природе пространства и времени.',
            'likes'=>'43',
            'views'=>'182',
            'image'=>'https://placehold.co/600x400',
            'category_id'=>2,
        ...
        DB::table('articles')->insert([
            ...
            'content'=>'Телескопы играют ключевую роль в астрономии. С телескопами, находящимися за пределами атмосферы Земли, такими как "Хаббл", удалось получить уникальные снимки и данные о нашем космосе. Они помогают исследовать фазы рождения и эволюции звезд. Объекты, как например туманность Ориона, детально изучаются с помощью этих телескопов. Они также позволяют астрономам собирать данные о галактиках и других космических объектах, продвигая наше понимание.',
            'likes'=>'4',
            'views'=>'127',
            'image'=>'https://placehold.co/600x400',
            'category_id'=>2,
        ...
        DB::table('articles')->insert([
            ...
            'content'=>'Космос не только визуальное пространство, но и мир звуков. Ученые фиксируют радиоволны, которые излучаются различными астрономическими объектами. Эти звуки могут рассказать нам о природе планет, звезд и других небесных тел. Некоторые исследователи пытаются интерпретировать космические данные в музыкальных формах, создавая уникальные композиции, которые знакомят нас с многочисленными аспектами Вселенной. Эти проекты помогают привлечь внимание к астрономии и популяризируют науку среди широкой аудитории.',
            'likes'=>'3',
            'views'=>'183',
            'image'=>'https://placehold.co/600x400',
            'category_id'=>1,
